...
use agielks\yii2\aws\s3\interfaces\HandlerResolver;
use agielks\yii2\aws\s3\interfaces\Service as ServiceInterface;
...
class Service extends Component implements ServiceInterface
{
     ...
     *
     * @return \agielks\yii2\aws\s3\CommandFactory
     */
     ...
     *
     * @return \agielks\yii2\aws\s3\interfaces\HandlerResolver
     */
    ...
    protected function defaultComponentDefinitions()
    {
        return [
            ...
            'resolver' => ['class' => 'agielks\yii2\aws\s3\HandlerResolver'],
            'bus' => ['class' => 'agielks\yii2\aws\s3\Bus'],
            'builder' => ['class' => 'agielks\yii2\aws\s3\CommandBuilder'],
            'factory' => ['class' => 'agielks\yii2\aws\s3\CommandFactory'],
        ];
    }
